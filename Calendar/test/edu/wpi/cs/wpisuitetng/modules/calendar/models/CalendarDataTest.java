...
public class CalendarDataTest {
	...
	public void testYears() {
		...
		assertNull( cd.getYear( 1984 ) );
		
		cd.addYear( 1984 );
		assertNotNull( cd.getYear( 1984 ) );
		...
		cd.addYear( 2101 );
		assertNotNull( cd.getYear( 2101 ) );
		assertFalse( cd.containsYear( 2100 ) );
		
		cd.removeYear( 1984 );
		assertFalse( cd.containsYear( 1984 ) );
	...
	public void testCopyFrom() {
		...
		YearData year1 = cd1.getYear( 1984 );
		...
		ArrayList< Event > retrievedEvents1 = days1[ 1 ].getEvents();
		
		YearData year2 = cd2.getYear( 1984 );
		DayData[] days2 = year2.getMonth( 2 ).getDays();
		ArrayList< Event > retrievedEvents2 = days2[ 1 ].getEvents();
	...
	public void testjSONConversion() {
		...
		cdOriginal.addYear( 1984 );
		cdOriginal.addYear( 2100 );
		...
		YearData year1 = cdOriginal.getYear( 1984 );
		year1.addEvent( event );
		...
		assertNotNull( cdNew.getYear( 1984 ) );
		assertNotNull( cdNew.getYear( 2100 ) );
		
		// Test that the event is also transferred
		DayData[] days1 = year1.getMonth( 2 ).getDays();
		ArrayList< Event > retrievedEvents1 = days1[ 1 ].getEvents();
		
		YearData year2 = cdNew.getYear( 1984 );
		DayData[] days2 = year2.getMonth( 2 ).getDays();
		ArrayList< Event > retrievedEvents2 = days2[ 1 ].getEvents();
		
		assertEquals( retrievedEvents1.size(), retrievedEvents2.size() );
		assertEquals( retrievedEvents1.get( 0 ).getStartTime().getSeconds(),
				      retrievedEvents2.get( 0 ).getStartTime().getSeconds() );
