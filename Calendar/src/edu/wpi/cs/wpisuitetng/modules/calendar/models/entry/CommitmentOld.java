 ...
 */
@Deprecated
public class CommitmentOld extends AbstractModel implements ICalendarEntry {
	// Parameters 2
	// ID Parameters
	 ...
	 */
	public CommitmentOld(int absoluteId, String projectId, String userId, String typeId,
	 ...
	 * @param tasks List<String> list of tasks for commitment
	 */
	public CommitmentOld( String name, String description, DateInfo dueDate,
