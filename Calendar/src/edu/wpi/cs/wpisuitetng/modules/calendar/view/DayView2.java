...
public class DayView2 extends JPanel {
	...
	public DayView2() {
		...
		JLabel lblam_4 = new JLabel("4:00AM");
		add(lblam_4, "cell 0 10");
		
		JLabel fourAM = new JLabel();
		...
		JLabel lblam_5 = new JLabel("5:00AM");
		add(lblam_5, "cell 0 12");
		
		JLabel fiveAM = new JLabel();
		...
		JLabel lblam_6 = new JLabel("6:00AM");
		add(lblam_6, "cell 0 14");
		
		JLabel sixAM = new JLabel();
		...
		JLabel lblam_7 = new JLabel("7:00AM");
		add(lblam_7, "cell 0 16");
		
		JLabel sevenAM = new JLabel();
		...
		JLabel lblam_8 = new JLabel("8:00AM");
		add(lblam_8, "cell 0 18");
		
		JLabel eightAM = new JLabel();
		...
		JLabel lblam_9 = new JLabel("9:00AM");
		add(lblam_9, "cell 0 20");
		
		JLabel nineAM = new JLabel();
		...
		JLabel lblam_10 = new JLabel("10:00AM");
		add(lblam_10, "cell 0 22");
		
		JLabel tenAM = new JLabel();
		...
		JLabel lblam_11 = new JLabel("11:00AM");
		add(lblam_11, "cell 0 24");
		
		JLabel elevenAM = new JLabel();
		...
		JLabel elevenHalfAM = new JLabel();
